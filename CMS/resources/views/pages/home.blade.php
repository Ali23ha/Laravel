        ...
        <div ui-view class="app-body" id="view">
            ...
            <div>
                <div class="row row-cols-lg-2 row-cols-sm-1" style="font-family:apple-system, system-ui, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif">
                    <div>
                        <h1 style="margin-left: 15px">VPS Hosting in the Cloud: Cost Efficiency Server Plans</h1>
                ...
                <button class="btn btn-fw black rounded" style="margin-left: 29px;margin-top: -577px; " type="submit">
                    <a href="{{route('Services-Index')}}">
                        <p style="font-size: 25px;margin-top: 10px;color: white">See Our Plans</p>
                    </a>
                </button>
