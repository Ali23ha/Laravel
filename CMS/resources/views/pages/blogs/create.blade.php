                    ...
                    <div class="box-body">
                        <form role="form">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter blog's name here">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Content</label>
                                <textarea  class="form-control" name="content" id="exampleInputPassword1"  rows="5" cols="50">
                                </textarea>
                            </div>
                            ...
                            <button type="submit" class="btn btn-outline rounded b-primary text-primary">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
